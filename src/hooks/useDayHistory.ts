...
import { calculateDailyTotals, calculateMealTotals } from '../utils/nutritionTotals';
...
function recalculateDay(day: DayRecord, meals: MealRecord[], goals: NutrientGoals): DayRecord {
