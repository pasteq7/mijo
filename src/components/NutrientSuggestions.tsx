      ...
      {suggestions.map((s, idx) => (
        ...
        >
          ...
          <button
            ...
            className="w-7 h-7 flex items-center justify-center rounded-xl text-[var(--text)] hover:text-[var(--accent)] hover:bg-[var(--accent-soft)] opacity-0 group-hover:opacity-100 transition-all"
          >
