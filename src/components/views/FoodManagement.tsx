...
export function FoodManagement({
  ...
  const macroRows: { key: NutrientKey; color: string }[] = [
    ...
    <>
      <div className="lg:hidden">
        <section className={`card flex min-h-[calc(100dvh-6.5rem)] flex-col overflow-visible p-4 transition-all duration-500 ${showHint ? 'card-breathing' : ''}`}>
          <div className="shrink-0 rounded-2xl border border-[var(--border-soft)] bg-[var(--bg-raised)]/95 px-3.5 py-3 shadow-[var(--shadow-sm)] backdrop-blur-md">
            <button
              type="button"
      ...
      <div className="hidden lg:grid lg:h-full lg:grid-cols-2 lg:gap-5" style={{ gridTemplateRows: 'auto minmax(0, 1fr)' }}>
