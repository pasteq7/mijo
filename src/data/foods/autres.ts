...
export const autres: Food[] = [
  ...
  },
  {
    ...
    per100g: {
      calories: 406, proteines: 8.2, glucides: 45.8, lipides: 21, fibres: 2.6,
      fer: 2, calcium: 37, magnesium: 16, zinc: 0.7, selenium: 18,
      vitA: 115, vitB9: 76, vitB6: 0.08, vitE: 0.7,
      omega3: 0.2, omega6: 1.2,
      lysine: 0.25, methionine: 0.16, leucine: 0.55, threonine: 0.25,
    },
  },
  {
    id: 'pain_au_chocolat', name: 'Pain au chocolat', emoji: '🥐',
    category: 'autres', seasons: ['printemps', 'ete', 'automne', 'hiver'],
    unit: 'g', defaultQty: 70,
    per100g: {
      calories: 423, proteines: 7.4, glucides: 45, lipides: 23.5, fibres: 3,
      fer: 2.4, calcium: 45, magnesium: 32, zinc: 0.9, selenium: 16,
      vitA: 105, vitB9: 62, vitB6: 0.07, vitE: 0.8,
      omega3: 0.2, omega6: 1.5,
      lysine: 0.24, methionine: 0.14, leucine: 0.5, threonine: 0.22,
    },
  },
  {
    ...
    unit: 'g', defaultQty: 60,
    per100g: {
      calories: 375, proteines: 8, glucides: 53, lipides: 14, fibres: 2.2,
      fer: 1.8, calcium: 70, magnesium: 18, zinc: 0.8, selenium: 17,
      vitA: 95, vitB9: 70, vitB6: 0.08, vitE: 0.8,
      omega3: 0.15, omega6: 1.1,
      lysine: 0.28, methionine: 0.15, leucine: 0.57, threonine: 0.26,
    },
  },
  {
    id: 'pain_aux_raisins', name: 'Pain aux raisins', emoji: '🥐',
    category: 'autres', seasons: ['printemps', 'ete', 'automne', 'hiver'],
    unit: 'g', defaultQty: 80,
    per100g: {
      calories: 360, proteines: 7.5, glucides: 52, lipides: 13.5, fibres: 2.8,
      fer: 2, calcium: 65, magnesium: 24, zinc: 0.8, selenium: 15,
      vitA: 80, vitB9: 58, vitB6: 0.08, vitE: 0.7,
      omega3: 0.15, omega6: 1.1,
      lysine: 0.25, methionine: 0.14, leucine: 0.52, threonine: 0.24,
    },
  },
  {
